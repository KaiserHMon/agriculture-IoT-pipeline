...
def sample_sensor_df():
    ...
    return pd.DataFrame({
        ...
        "Unit": ["F", "C", "F"],
        "Timestamp": ["2024-03-30 10:00:00", "2024-03-30 10:05:00", "2024-03-30 10:00:00"]
    })
...
def test_transformation_logic_pipeline(sample_sensor_df):
    """Simulates the core transformation steps of the lambda_handler."""
    df = sample_sensor_df.copy()
    ...
    # 4. Null Management
    df_with_nulls = pd.concat([df_dedup, pd.DataFrame([{
